...
import 'package:mapbox_test/main.dart';
import 'package:mapbox_test/utils.dart';
import 'package:permission_handler/permission_handler.dart';

class AnimatedRoutePage {
  AnimatedRoutePage();
...
class AnnotationClickListener extends OnPointAnnotationClickListener {
  ...
  void onPointAnnotationClick(PointAnnotation annotation) async {
    ...
    final coordinates =
        await fetchRouteCoordinates(start, end.coordinates, accessToken);
